...
export default function Demographics({ onContinue }: ClassificationTaskProps) {
  ...
  const getData = () => ({ age, hispanicLatino, races, otherRace, sex, zipCode });
  ...
  return (
    <div className="min-h-full w-full flex flex-col items-center justify-center bg-black overflow-y-auto h-screen">
              ...
              {RACE_OPTIONS.map((race) => (
                <label key={race} className="flex items-center space-x-3 cursor-pointer">
                  <input
                    ...
                    className="w-5 h-5 text-blue-600 bg-gray-800 border-white rounded focus:ring-blue-500"
                  />
