...
interface QuestionnairePageProps {
  ...
  /** Demographics locks to one viewport-height screen (no scrolling). */
...
export default function QuestionnairePage({
  ...
  return (
    <div
      className={`min-h-full w-full flex flex-col items-center justify-center bg-black ${
        lockViewport ? "overflow-hidden h-screen" : "pb-24"
      }`}
    >
      {title && (
